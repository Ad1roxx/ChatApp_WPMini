 ...
 * its arguments and the component can render the same output twice.
 */
 ...
 * props would produce different output — and React's compiler rules reject
 * it. Holding the time in state instead fixes that and buys something real:
 * "in 2 minutes" turns into "2 minutes ago" on its own, and a session moves
 * from Upcoming to Past without anyone refreshing the page.
 *
 * A minute is the resolution the labels are written at, so ticking faster
